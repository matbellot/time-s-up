...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Controlla il limite quando si fa focus sull'input (utile per mobile)
...
// Controlla se il giocatore corrente ha raggiunto il limite di parole
...
function updatePlayerLabel() {
    ...
    // Controlla immediatamente il limite per questo giocatore
    checkWordLimit();
}
...
function addWord() {
    ...
    // Controllo aggiuntivo: se l'input è già disabilitato, non fare nulla
